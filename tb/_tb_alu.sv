...
// Teste unitario da ALU. A antiga interface temporaria no topo foi removida
// quando a ALU passou a receber os sinais reais do estagio Execute.
module tb_alu;
    ...
    initial begin
        // Uma verificacao para cada codigo de operacao da ALU atual.
        ...
        // Casos de limite preservam a cobertura das flags aritmeticas.
        ...
        $display("PASS: all ALU operations and flags completed");
        $finish;
    end
